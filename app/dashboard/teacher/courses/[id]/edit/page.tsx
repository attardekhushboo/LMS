...
export default function EditCoursePage() {
  ...
  if (fetching) {
     return <div className="flex h-40 items-center justify-center"><Loader2 className="animate-spin text-cyan-500 w-8 h-8" /></div>
  }
      ...
      >
        <Card className="border-0 bg-white/80 shadow-xl backdrop-blur">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-extrabold text-gray-800">Edit Course</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full rounded-md border-2 border-cyan-200 bg-white/70 p-3 text-base focus:border-cyan-400 focus:outline-none min-h-[100px]"
                />
              </div>
